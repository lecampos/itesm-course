...
class DualVNH5019MotorShield
{
  public:  
    ...
    DualVNH5019MotorShield(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
                           unsigned char INA2, unsigned char INB2, unsigned char EN2DIAG2, unsigned char CS2,unsigned char EN_PIN_1,unsigned char EN_PIN_2); // User-defined pin selection. 
  ...
  private:
    ...
    unsigned char _CS2;
	unsigned char _EN_PIN_1;
	unsigned char _EN_PIN_2;
